...
import { Quiz, User, QuizAttempt, Question } from "../lib/types";
      ...
      <div className="max-w-4xl mx-auto p-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create a random quiz with questions from all your available
              quizzes
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mb-4">
                Questions will be randomly selected from {myQuizzes.length}{" "}
                quiz(zes)
              </p>
            </div>
            ...
            {allQuestions.length === 0 && (
              <p className="text-sm text-red-600 text-center">
                No questions available. Complete some quizzes first to unlock
                practice mode.
              </p>
            )}
          </CardContent>
